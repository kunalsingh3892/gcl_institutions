...
class _SettingsState extends State<AddBatch> {
  bool _value = false;
  Future _chapterData;
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    ...
                    final msg = jsonEncode({
                      ...
                      "batch_name": subjectController.text,
                      "enabled": "1"
                    });
                    ...
                    var response = await http.post(
                      new Uri.https(BASE_URL, API_PATH + "/batch-create"),
                      body: {
                        "institute_id": user_id,
                        "batch_name": subjectController.text,
                        "enabled": "1"
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Container(
            child: Text("Create Batch", style: normalText6),
          ),
