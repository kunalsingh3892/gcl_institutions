...
class _SettingsState extends State<QuestionView> {
  ...
  Future _getChapterData() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/institute-test-submited_list_question_overview"),
      body: {
        "test_id":test_id
              ...
              return
                Container(
                  child: ListView.builder(
                      shrinkWrap: true,
                      primary: false,
                      itemCount: snapshot.data['Response']['question_list']
                          .length,
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            child: _buildWikiCategory(
                                                "Chapter",
                                                snapshot
                                                    .data['Response']['question_list'][index]['chapter_name'],
                                                Color(0xff415EB6),
                                                Color(0xffEEF7FE)),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            child: _buildWikiCategory(
                                                "Topic",
                                                snapshot
                                                    .data['Response']['question_list'][index]['topic_name'],
                                                Color(0xffFFB110),
                                                Color(0xffFFFBEC)),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: InkWell(
                                              ...
                                              Navigator.pushNamed(
                                                ...
                                                arguments: <String, String>{
                                                  ...
                                                  'question_id': snapshot
                                                      .data['Response']['question_list'][index]['question_id']
                                                      .toString(),
                                                  'result_type': "R",
                                                },
                                              );
                                            ...
                                            child: _buildWikiCategory(
                                                "Right %",
                                                snapshot
                                                    .data['Response']['question_list'][index]['R']
                                                    .toString(),
                                                Color(0xff38CD8B),
                                                Color(0xffE9FFF5)),
                                          ),
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            child: _buildWikiCategory(
                                                "Wrong %",
                                                snapshot
                                                    .data['Response']['question_list'][index]['W']
                                                    .toString(),
                                                Color(0xffFFB110),
                                                Color(0xffFFFBEC)),
                                          ),
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            child: _buildWikiCategory(
                                                "Parameter",
                                                snapshot
                                                    .data['Response']['question_list'][index]['parameter'],
                                                Color(0xff38CD8B),
                                                Color(0xffE9FFF5)),
                                          ),
                                        ),
