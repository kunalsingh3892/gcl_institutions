                      ...
                      child: Column(children: <Widget>[
                        ...
                        Row(
                          ...
                          Expanded(
                            child: Center(
                              child: Container(
                                  child: Text(snapshot.data['Response'][index]['totalmcq'].toString()+" MCQ/ "+ snapshot.data['Response'][index]['totaldetails'].toString() +" Detailed",
                                      style: normalText1),
                                ),
                            ),
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        setState(() {
                                          topicJson.topicid=snapshot.data['Response'][index]['topic_id'].toString();
                                          topicJson.mcqattempt=_controllersMCQ[index].text;
                                          topicJson.detailsattempt=_controllersDetail[index].text;
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: TextFormField(
                                      ...
                                      onSaved: (value) {
                                        _controllersDetail[index].text = value;
                                      },
                                      onChanged: (value) {
