...
class StudentSummary extends StatefulWidget {
  ...
  const StudentSummary({Key key, this.argument}) : super(key: key);
  @override
  _SettingsState createState() => _SettingsState();
}

class _SettingsState extends State<StudentSummary> {
  bool _value = false;
  Future _chapterData;
  ...
  Future _getChapterData() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/institute-test-submited_list"),
      body: {
        "test_id":test_id,
    ...
    return TableRow(
      ...
      children: [
        Container(
          ...
          child: Container(
              child: AutoSizeText(result['student_name'],
        ...
        Container(
            ...
            alignment: Alignment.center,
            child: Container(
                child: AutoSizeText(result['W'].toString(),
                    textAlign: TextAlign.center,
                    maxLines: 1,
                    style: normalText2))),
        Material(
    ...
    return TableRow(
      ...
      children: [
        Container(
          ...
          alignment: Alignment.center,
          child: Container(
              child: AutoSizeText(result['student_name']+" - "+result['mobile'].toString(),
                  textAlign: TextAlign.center,
                  maxLines: 3,
                  style: normalText7)),
        ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              child: Text(
                                                  snapshot.data['Response']['submited']['total_submited'].toString(),
                                                  maxLines: 2,
                                                  softWrap: true,
                                                  overflow:
                                                  TextOverflow.ellipsis,
                                  ...
                                  Container(
                                    ...
                                    child: Table(
                                      ...
                                      children: List.generate(
                                          snapshot.data['Response']['submited']['submited_student_list'].length,
                                              (index) => _getDataRow1(
                                                snapshot.data['Response']['submited']['submited_student_list'][index],
                                                  snapshot.data['Response']['submited']['submited_student_list']
                                          )),
                                    ),
                                  ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            Expanded(
                                              child: Text(
                                                  "Students List (Still Not Submitted) ",
                                                  maxLines: 3,
                                                  softWrap: true,
                                                  overflow:
                                                  TextOverflow.ellipsis,
                                            ...
                                            Container(
                                              child: Text(
                                                  snapshot.data['Response']['non_submited']['total__not_submited'].toString(),
                                                  maxLines: 2,
                                                  softWrap: true,
                                                  overflow:
                                                  TextOverflow.ellipsis,
                                ...
                                child: Column(children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Table(
                                      ...
                                      children: List.generate(
                                          snapshot.data['Response']['non_submited']['not_submited_student_list'].length,
                                              (index) => _getDataRow(
                                              snapshot.data['Response']['non_submited']['not_submited_student_list'][index],
                                              snapshot.data['Response']['non_submited']['not_submited_student_list']
                                          )),
                                    ),
                                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Container(
            child: Text("Students Summary", style: normalText6),
          ),
