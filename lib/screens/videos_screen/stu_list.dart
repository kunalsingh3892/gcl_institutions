...
class StudentListTwo extends StatefulWidget {
  final Object argument;

  const StudentListTwo({Key key, this.argument}) : super(key: key);
  @override
  _SettingsState createState() => _SettingsState();
}

class _SettingsState extends State<StudentListTwo> {
  bool _value = false;
  Future _chapterData;
  ...
  Future _getChapterData(String name) async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/test-student_list_performance"),
      body:{
        "test_id":test_id,
    ...
    if (response.statusCode == 200) {
      ...
      if(data['ErrorCode']==0) {
        var result = data['Response']['question_list'];
        setState(() {
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                Expanded(
                                                  child: Text(
                                                      snapshot
                                                          .data['Response']['question_list'][index]['name'],
                                                      maxLines: 3,
                                                      softWrap: true,
                                                      overflow:
                                                      TextOverflow.ellipsis,
                                            ...
                                            snapshot
                                                .data['Response']['question_list'][index]['mobile'] !=
                                                null ? Container(
                                              child: Text(
                                                  snapshot
                                                      .data['Response']['question_list'][index]['mobile']
